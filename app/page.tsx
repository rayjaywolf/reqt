    ...
    switch (currentScreen) {
        ...
        return (
          <section className="bg-black border-2 border-white p-0 overflow-hidden h-full flex flex-col justify-start">
            <div className="bg-white text-black p-2">
              <h1 className="text-xl md:text-xl font-mono font-black tracking-tight text-center uppercase">ROAST MY PORTFOLIO</h1>
            </div>
            ...
            <div className="p-4 flex-1 flex flex-col items-center justify-center">
              ...
              <div className="mb-6 font-mono text-white text-center max-w-sm px-2">
              ...
              <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-2 w-full max-w-sm px-4">
                <div className="grid grid-cols-1 gap-2">
                  <input
                    ...
                    className="px-3 py-3 bg-white text-black border-2 border-black focus:outline-none focus:border-purple-600 font-mono uppercase text-xs text-center"
                    aria-label="Solana wallet address"
                  />
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="px-3 py-3 bg-purple-600 text-white border-2 border-black font-mono font-black uppercase text-xs hover:bg-yellow-400 hover:text-black transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
      ...
      case 'analyzing':
        return (
          <section className="bg-black border-2 border-white p-0 overflow-hidden h-full flex flex-col justify-center">
            <div className="bg-white text-black p-2">
              <h1 className="text-xl md:text-2xl font-mono font-black tracking-tight text-center uppercase">ANALYZING YOUR MISTAKES</h1>
            </div>

            <div className="p-4 flex-1 flex flex-col justify-center items-center">
              <div className="font-mono text-white text-center w-full max-w-2xl px-4">
                <div className="text-lg md:text-xl mb-3 flex justify-center">
                  <span className="bg-purple-600 text-white px-4 py-1">WALLET: {walletAddress.slice(0, 6)}...{walletAddress.slice(-4)}</span>
                </div>

                <div className="text-base md:text-lg mb-4 bg-white p-3 border-2 border-black">
                ...
                <div className="mt-4 text-xs md:text-sm text-purple-600 font-black">
      ...
      case 'wallet':
        return (
          <section className="bg-black border-2 border-white p-0 overflow-hidden h-full flex flex-col">
            <div className="bg-white text-black p-2">
              <h1 className="text-xl md:text-2xl font-mono font-black tracking-tight text-center uppercase">WALLET LOADED</h1>
            </div>
            ...
            <div className="p-4 flex-1 flex flex-col">
              <div className="border-4 border-white mb-4">
                <div className="bg-white text-black p-2 border-b-4 border-black flex items-center justify-between">
                  <span className="font-black text-base md:text-lg uppercase">WALLET DETAILS</span>
                  <span className="bg-black text-white px-2 py-1 font-mono text-xs md:text-sm">{walletAddress.slice(0, 6)}...{walletAddress.slice(-4)}</span>
                </div>

                <div className="grid grid-cols-2 font-mono">
                  <div className="bg-purple-600 p-4 md:p-6 border-r-4 border-white border-b-4 flex flex-col items-center justify-center">
                    <div className="text-white font-black text-xl md:text-2xl">{portfolioData?.nativeBalance?.solana || "0"}</div>
                    <div className="text-white font-black uppercase text-xs md:text-sm">SOL</div>
                  </div>

                  <div className="bg-yellow-400 p-4 md:p-6 border-b-4 border-white flex flex-col items-center justify-center">
                    <div className="text-black font-black text-xl md:text-2xl">{portfolioData?.tokens?.length || 0}</div>
                    <div className="text-black font-black uppercase text-xs md:text-sm">TOKENS</div>
                  </div>

                  <div className="bg-cyan-400 p-4 md:p-6 border-r-4 border-white flex flex-col items-center justify-center">
                    <div className="text-black font-black text-xl md:text-2xl">{portfolioData?.nfts?.length || 0}</div>
                    <div className="text-black font-black uppercase text-xs md:text-sm">NFTS</div>
                  </div>

                  <div className="bg-green-400 p-4 md:p-6 flex flex-col items-center justify-center">
                    <div className="text-black font-black text-xl md:text-2xl">{portfolioData?.swaps?.length || 0}</div>
                    <div className="text-black font-black uppercase text-xs md:text-sm">SWAPS</div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-auto mb-2 flex flex-col items-center gap-3">
                <button
                  onClick={handleRoast}
                  disabled={isRoasting}
                  className="w-full md:w-auto px-6 md:px-8 py-3 bg-white text-black border-4 border-black font-mono font-black uppercase text-base md:text-lg hover:bg-purple-600 hover:text-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  &gt;&gt; ROAST THIS WALLET &lt;&lt;
                </button>
                ...
                <button
                  onClick={handleReset}
                  className="w-full md:w-auto px-4 py-2 bg-black text-white border-4 border-white font-mono font-black uppercase text-xs hover:bg-red-500 hover:text-white transition-colors"
                >
      ...
      case 'roasting':
        return (
          <section className="bg-black border-2 border-white p-0 overflow-hidden h-full flex flex-col justify-center">
            <div className="bg-white text-black p-2">
              <h1 className="text-xl md:text-2xl font-mono font-black tracking-tight text-center uppercase">ROASTING YOUR PORTFOLIO</h1>
            </div>
      ...
      case 'result':
        return (
          <section className="bg-black p-0 overflow-hidden h-full flex flex-col">
            <div className="bg-white text-black p-2">
              <h1 className="text-xl md:text-2xl font-mono font-black tracking-tight text-center uppercase">PORTFOLIO ROAST</h1>
            </div>

            <div className="p-4 flex-1 flex flex-col justify-center">
              <div className="font-mono text-white h-full flex items-center justify-center">
                <div className="flex flex-col md:flex-row items-start gap-4 md:gap-6 max-w-4xl w-full px-4">
                  ...
                  <div className="flex-1 bg-white p-4 md:p-6 rounded-lg border-2 border-white relative flex">
                    <div className="absolute left-[-12px] top-8 w-0 h-0 border-t-[12px] border-t-transparent border-r-[12px] border-r-white border-b-[12px] border-b-transparent hidden md:block" />
                    <div
                      dangerouslySetInnerHTML={{ __html: typedContent }}
                      className="text-black text-base md:text-xl relative font-black leading-relaxed whitespace-pre-wrap"
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="p-3 flex justify-between bg-black">
              <button
                ...
                className="px-3 md:px-4 py-2 bg-white text-black border-2 border-black font-mono font-black uppercase text-xs md:text-sm hover:bg-pink-500 hover:text-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                &lt;&lt; PREVIOUS
              </button>
              ...
              {currentParagraphIndex < roastParagraphs.length - 1 ? (
                <button
                  ...
                  className="px-3 md:px-4 py-2 bg-purple-600 text-white border-2 border-black font-mono font-black uppercase text-xs md:text-sm hover:bg-orange-400 hover:text-black transition-colors"
                >
                  NEXT &gt;&gt;
                </button>
              ) : (
        ...
        return (
          <section className="bg-black p-0 overflow-hidden h-full flex flex-col">
              ...
              <div className="font-mono text-white h-full flex items-center justify-center">
                <div className="flex flex-col items-center gap-4 max-w-md w-full px-4">
                  <div className="bg-[#ff0000] p-4 border-4 border-black w-full">
                    <h2 className="text-xl md:text-2xl font-black tracking-tight uppercase text-white font-mono text-center">ANTI-RUG FORCE</h2>
                    <p className="text-base md:text-lg font-black tracking-tight uppercase text-white font-mono text-center mt-1">DETECT. PROTECT. PROFIT.</p>
                  </div>
                  ...
                  <div className="bg-[#ffff00] p-3 border-4 border-black w-full">
                    <p className="text-black text-base md:text-lg font-black tracking-tight uppercase font-mono text-center">COMING SOON: 27.04.25</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="p-3 flex justify-between bg-black">
              <button
                onClick={handleReset}
                className="px-3 md:px-4 py-2 bg-white text-black border-2 border-black font-mono font-black uppercase text-xs md:text-sm hover:bg-pink-500 hover:text-white transition-colors"
              >
              ...
              <Link href="/anti-rug-force">
                <button
                  className="px-3 md:px-4 py-2 bg-[#ff0000] text-white border-2 border-black font-mono font-black uppercase text-xs md:text-sm hover:bg-[#ffff00] hover:text-black transition-colors"
                >
